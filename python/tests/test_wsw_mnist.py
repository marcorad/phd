...
S_train = ws.scatteringTransform(torch.from_numpy(X_train), batch_dim=0, batch_size=256)
S_test  = ws.scatteringTransform(torch.from_numpy(X_test) , batch_dim=0, batch_size=256)
print(S_train.shape)
