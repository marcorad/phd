classdef SEGMM < handle
    ...
    properties
        ...
        MDist_s %the Mahalanobis distance between the signal mean given the noise distribution
        MDist_n %the Mahalanobis distance between the noise mean given the signal distribution
        MDist_minH %the Mahalanobis distance between the minimum observed entropy and the noise distribution
    end
    ...
    methods(Static)
        ...
        function z = MahalanobisDist(x, mu, sigma)
           z = abs((x-mu)/sigma);
        end
    end
    ...
    methods
        ...
        function calcDistances(this)
            ...
            this.MDist_s = this.MahalanobisDist(this.mu_s, this.mu_n, this.sigma_n);
            this.MDist_n = this.MahalanobisDist(this.mu_n, this.mu_s, this.sigma_s);
            this.MDist_minH = this.MahalanobisDist(this.Hmin, this.mu_n, this.sigma_n);
        end
